        ...
        <main>
            <animated.section style={fadeIn} className="min-h-screen bg-[#005BFF] text-white flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col justify-center items-center space-y-3 sm:space-y-0 sm:space-x-4">
                    <div>
                        <h1 className="text-xl sm:text-3xl lg:text-5xl font-bold break-normal text-center">Welcome!</h1>
                        <p className="text-sm sm:text-lg lg:text-2xl text-center">Please login to your account.</p>
                        <div className="flex flex-col space-y-2 mt-4 items-center">
                            ...
                            <button className="bg-white text-[#005BFF] py-2 px-4 rounded hover:text-gray-300 hover:bg-blue-500 w-52">Login</button>
                        </div>
                    </div>
                </div>
            </animated.section>
